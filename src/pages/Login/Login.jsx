                ...
                <div className="w-full">
                    ...
                    <form onSubmit={handleFormSubmit} className="w-11/12 mx-auto">
                        ...
                        <div className="form-control mt-6">
                            <button className="btn max-lg:btn-sm className='btn bg-gradient-to-r from-[#01769a86] via-[#20758a] dark:to-[#01769a86] text-white border-none duration-1000 hover:bg-primary btn-sm' lg:text-xl">Login</button>
                        </div>
                    </form>
                </div>
            </div>
