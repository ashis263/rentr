            ...
            <div className='w-4/5 lg:w-1/3 sm:w-1/2'>
                ...
                <form onSubmit={handleFormSubmit} className="w-11/12 mx-auto">
                    ...
                    <div className="form-control mt-6">
                        <button className="btn max-lg:btn-sm className='btn bg-gradient-to-r from-[#01769a86] via-[#20758a] dark:to-[#01769a86] text-white border-none duration-1000 hover:bg-primary btn-sm' lg:text-xl">Register</button>
                    </div>
                </form>
            </div>
            </HelmetProvider>
