            ...
            <Modal className="" open={isModalOpened} onClose={handleModal}>
                ...
                <form className='px-5' onSubmit={handleFormSubmit}>
                    ...
                    <div className="form-control">
                        ...
                        <select className={`border rounded-lg p-2 border-gray-200 max-sm:select-sm`} name="availability" required>
                            <option></option>
                    ...
                    <div className="form-control mt-6">
                        <button className="btn max-lg:btn-sm hover:bg-primary border-none bg-primary text-white lg:text-xl">Update</button>
                    </div>
                </form>
            </Modal>
        </tr>
