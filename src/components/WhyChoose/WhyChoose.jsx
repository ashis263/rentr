...
const WhyChoose = () => {
    AOS.init();
    return (
        <div  data-aos="fade-up" data-aos-duration="1000" className="w-11/12 mx-auto m-5 mb-20 sm:mb-20 sm:my-8 lg:mb-32 sm:-mt-16">
            ...
            <div  data-aos="fade-in" data-aos-duration="1000"  className="pt-5 sm:pt-10 grid grid-cols-2 mx-auto gap-2 sm:gap-5">
