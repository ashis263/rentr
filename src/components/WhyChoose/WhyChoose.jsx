    ...
    return (
        <div className="w-11/12 mx-auto m-5 mb-20 sm:mb-20 sm:my-8 lg:mb-32 sm:-mt-16">
            ...
            <div className="pt-5 sm:pt-10 grid grid-cols-2 mx-auto gap-2 sm:gap-5">
                <div className="bg-slate-100 px-5 py-14 space-y-2 rounded-tl-xl text-center flex items-center flex-col drop-shadow-xl">
                ...
                <div className="bg-slate-100 px-5 py-14 space-y-2 rounded-tr-xl text-center flex items-center flex-col drop-shadow-xl">
                ...
                <div className="bg-slate-100 px-5 py-14 space-y-2 rounded-bl-xl text-center flex items-center flex-col drop-shadow-xl">
                ...
                <div className="bg-slate-100 px-5 py-14 space-y-2 rounded-br-xl text-center flex items-center flex-col drop-shadow-xl">
