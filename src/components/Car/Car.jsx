...
const Car = ({ car }) => {
    ...
    return (
        <div className='flex flex-col shadow p-5 rounded-xl gap-5 items-center bg-white'>
            ...
            <div className='w-11/12 mx-auto'>
                ...
                <p className='text-xs text-gray-500 py-5 h-32 overflow-scroll'>{description}</p>
